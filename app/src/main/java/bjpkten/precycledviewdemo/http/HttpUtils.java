...
//
     ...
     */
    public static <T> void getRequestForResultList(String path, String cookie,HashMap<String,String> values, RequestCallback<ResultList<T>> callback, T t) throws Exception {
        requestForResultList("GET",cookie,path,values,callback,t);
    }

    /**
     * POST 的请求的获取ResultList
     */
    public static <T> void postRequestForResultList(String path, String cookie,HashMap<String,String> values, RequestCallback<ResultList<T>> callback,T t) throws Exception {
        requestForResultList("POST",cookie,path,values,callback,t);
    }
//
//
//    /**
...
//     * @throws Exception
//     */
//    private static <T> void requestForResult(String postOrGet, String path, HashMap<String,String> values, RequestCallback<kodulf.baselibs.http.Result<T>> callback, final T t) throws Exception {
//
...
//
//
//    public static <T> void getDownload(String urlString, File returnFile, RequestCallback<kodulf.baselibs.http.Result<T>> requestCallback) throws Exception {
//        download("GET",urlString,returnFile,requestCallback);
//    }
//
//    public static <T> void postDownload(String urlString, File returnFile, RequestCallback<kodulf.baselibs.http.Result<T>> requestCallback) throws Exception {
...
//     * @throws Exception
//     */
//    private static <T> void download(String getOrPost, String urlString, File returnFile, RequestCallback<kodulf.baselibs.http.Result<T>> requestCallback) throws Exception{
...
//
//        kodulf.baselibs.http.Result<T> result = new kodulf.baselibs.http.Result();
...
//                result.setError_code(kodulf.baselibs.http.Result.SUCCESS);
...
//
    ...
    private static <T> void requestForResultList(String postOrGet, String cookie, String path, HashMap<String,String> values, RequestCallback<ResultList<T>> callback, T t) throws Exception {
            ...
            try {
                ...
                if(inputStream!=null&& byteArrayOutputStream !=null) {
                    ...
                    if(resultList.isSuccess()) {
                        ...
                        callback.onFailure(resultList,new Exception("服务器返回成功200，但是数据处理失败:"+(resultList.getMsg()!=null?resultList.getMsg():"")));
                    }
                }else{
                    callback.onFailure(resultList,new Exception("服务器返回码200\n 本地在进行返回处理的时候报错"));
                }
